...
# for this example, we'll use the URL for the 2024 San Francisco Monitor Data
url <- "https://www3.epa.gov/cgi-bin/broker?_service=data&_program=dataprog.Daily.sas&check=site&debug=0&year=2024&site=06-075-0005"
...
file_name <- file.path(data_dir, "daily_sf_2024.csv")
...
p <- ggplot(data = df, aes(x = date, y = value, color = poll)) +
  ...
  labs(x = "Date",
       ...
       color = "Metal", 
       title = "EPA Chemical Speciation Network, San Francisco Monitor") + 
