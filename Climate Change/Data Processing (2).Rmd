...
# another way of dealing with time 
sf_weather <- sf_weather %>% 
...
ggplot(sf_weather, aes(x = date_new, y = temp_f, color = datatype)) + geom_point()
...
ggplot(sf_weather, aes(x = date_new, y = temp_f, color = datatype)) +
  geom_point() +
  scale_x_date(
